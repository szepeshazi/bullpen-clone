...
Hint? lookAheadRule(HintContext ctx) =>
...
Hint? _penLookAhead(HintContext ctx) {
  for (final pen in ctx.board.pens) {
    ...
    final hint = _scan(ctx, valid, (r, c, r2, c2) {
      if (r2 == r && ctx.rowCounts[r] + 1 >= 2) {
        return true;
      }
      if (c2 == c && ctx.colCounts[c] + 1 >= 2) {
        return true;
      }
      return false;
    }, 'this pen');
